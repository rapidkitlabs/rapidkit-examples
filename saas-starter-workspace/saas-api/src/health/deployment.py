"""Project shim exposing vendor health helpers for deployment."""
...
_VENDOR_MODULE = "deployment"
_VENDOR_VERSION = "0.1.13"
_VENDOR_RELATIVE_PATH = "src/health/deployment.py"
_VENDOR_ROOT_ENV = "RAPIDKIT_VENDOR_ROOT"
_CACHE_PREFIX = "rapidkit_vendor_deployment"
...
try:
    register_deployment_health = _resolve_export("register_deployment_health")
except Exception:
    register_deployment_health = _fallback_register
